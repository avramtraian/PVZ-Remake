...
enum game_asset_id : u32
{
    ...
    GAME_ASSET_ID_PLANT_REPEATER,
    GAME_ASSET_ID_PLANT_TORCHWOOD,
    GAME_ASSET_ID_PLANT_MELONPULT,
    GAME_ASSET_ID_PLANT_WALLNUT_NORMAL,
    GAME_ASSET_ID_PLANT_WALLNUT_CRACKED_1,
    GAME_ASSET_ID_PLANT_WALLNUT_CRACKED_2,
    GAME_ASSET_ID_PROJECTILE_SUN,
    GAME_ASSET_ID_PROJECTILE_PEA,
    GAME_ASSET_ID_PROJECTILE_FIRE_PEA,
    GAME_ASSET_ID_PROJECTILE_MELON,
    GAME_ASSET_ID_ZOMBIE_NORMAL,
    GAME_ASSET_ID_ZOMBIE_BUCKET_DAMAGED_0,
    GAME_ASSET_ID_ZOMBIE_BUCKET_DAMAGED_1,
    GAME_ASSET_ID_ZOMBIE_BUCKET_DAMAGED_2,
    GAME_ASSET_ID_UI_SEED_PACKET,
    GAME_ASSET_ID_UI_SHOVEL,
